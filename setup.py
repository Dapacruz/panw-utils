...
requirements = ['cryptography==39.0.1', 'netmiko==3.3.0', 'paramiko==2.7.2', 'lxml==4.5.2']
...
setup(
    ...
    entry_points={
        "console_scripts":[
            ...
            'run-panw-cmd=panw_utils.run_panw_cmd:main',
            'exec-panw-cmd=panw_utils.run_panw_cmd:main',
        ]
    },
)
